        ...
        Container(
          ...
          child: TextFormField(
            ...
            style: kBodyText
                .copyWith(
                  fontSize: 18.5,
                  fontWeight: specialText ? FontWeight.w900 : FontWeight.w600,
                )
                .copyWith(fontSize: specialText ? 28 : null),
            autovalidateMode:
            ...
            decoration: InputDecoration(
              ...
              focusedBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(6),
                borderSide:
                    const BorderSide(color: Color(0xFF01346B), width: 0.9),
              ),
              ...
              hintStyle: kBodyText
                  .copyWith(
                      fontSize: 18.5,
                      fontWeight: /* specialText ? FontWeight.w900 : */
                          FontWeight.w600,
                      color: const Color(0xFF656565))
                  .copyWith(fontSize: specialText ? 18 : null),
